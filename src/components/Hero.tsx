                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center max-w-6xl mx-auto">
                    ...
                    <div className="lg:col-span-7 text-center lg:text-left space-y-6 flex flex-col items-center lg:items-start order-2 w-full">
                        ...
                        <div className="flex flex-wrap gap-4 justify-center lg:justify-start items-center">
                            ...
                            <button
                                onClick={handleContact}
                                className="relative flex items-center gap-3 rounded-full border border-blue-500/20 bg-blue-500/5 hover:bg-blue-500/10 backdrop-blur-md px-8 py-[18px] text-base font-semibold text-foreground/90 transition-all duration-300 hover:border-blue-500/40 hover:scale-105 shadow-[0_4px_30px_rgba(0,0,0,0.1)] group"
                            >
                        ...
                        <div className="flex flex-wrap justify-center lg:justify-start gap-4 text-sm font-medium">
                            <div className="flex items-center gap-2 border border-blue-500/10 bg-blue-500/5 backdrop-blur-md rounded-full px-5 py-2.5 text-foreground/80 shadow-sm transition-all duration-300 hover:border-blue-500/25 hover:text-foreground">
                                <MapPin className="text-blue-400 w-4 h-4 animate-jump-pulse" />
                                <span>Mumbai, India</span>
                            </div>
                            <div className="flex items-center gap-2 border border-blue-500/10 bg-blue-500/5 backdrop-blur-md rounded-full px-5 py-2.5 text-foreground/80 shadow-sm transition-all duration-300 hover:border-blue-500/25 hover:text-foreground">
                                <Globe className="text-blue-400 w-4 h-4 animate-spin-slow" />
