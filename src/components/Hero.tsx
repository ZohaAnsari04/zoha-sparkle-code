...
const Hero = () => {
    ...
    return (
        <section
            id="hero"
            className="min-h-[85vh] md:min-h-screen flex items-start justify-center relative overflow-hidden pt-20 md:pt-32"
            style={{
        ...
        >
            ...
            <div className="container mx-auto px-4 pt-0 pb-10 md:pb-20 relative z-10">
