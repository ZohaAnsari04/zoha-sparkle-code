...
const TiltProjectCard = ({
  ...
  return (
    <motion.div
      ...
      className={`relative group overflow-hidden bg-[#09090c]/75 backdrop-blur-2xl border border-white/10 rounded-[24px] shadow-[0_20px_50px_rgba(0,0,0,0.8),0_0_30px_rgba(255,45,85,0.05)] hover:border-[#ff2d55]/40 hover:shadow-[0_25px_60px_rgba(0,0,0,0.9),0_0_50px_rgba(255,45,85,0.2)] transition-all duration-500 ${className}`}
    >
      ...
      <div
        ...
        style={{
          background: `radial-gradient(450px circle at ${mousePos.x}px ${mousePos.y}px, rgba(255, 45, 85, 0.12), transparent 70%)`
        }}
      />
...
const TechPill = ({ name }: { name: string }) => {
  return (
    <motion.span
      ...
      className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-white/[0.04] border border-white/10 text-[11px] font-medium text-white/80 hover:text-white hover:border-[#ff2d55]/50 hover:bg-[#ff2d55]/10 hover:shadow-[0_0_12px_rgba(255,45,85,0.25)] transition-all duration-300 backdrop-blur-md"
    >
      <span className="w-1 h-1 rounded-full bg-[#ff2d55]" />
      {name}
    </motion.span>
  );
};
...
const Projects = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mouse Follow Ambient Spotlight Tracker */}
      <div
      ...
      <div className="relative z-10 max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="max-w-4xl mx-auto text-center mb-12 sm:mb-16">
          ...
          >
            Featured <span className="animate-gradient-text-red">Projects</span>
          </motion.h2>
                    ...
                    <div className="md:col-span-5 flex flex-col justify-between h-full space-y-4">
                      <div>
                        <div className="flex items-center gap-2 mb-3">
                          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#ff2d55]/10 border border-[#ff2d55]/30 text-[11px] font-bold text-[#ff2d55] shadow-[0_0_12px_rgba(255,45,85,0.2)]">
                            <Sparkles className="w-3 h-3 animate-pulse" />
                            Featured
                          </span>
                        </div>

                        <h3 className="text-2xl sm:text-3xl font-bold text-white tracking-tight font-playfair group-hover:text-[#ff2d55] transition-colors leading-tight">
                            ...
                            return (
                              ...
                              >
                                <div className="flex items-center gap-1 text-[10px] text-white/50">
                                  <Icon className="w-2.5 h-2.5 text-[#ff2d55]" />
                        ...
                        <div className="flex items-center gap-2 flex-shrink-0">
                          {featuredProject.demo && (
                            <a
                              ...
                              className="p-2.5 rounded-xl bg-[#ff2d55]/10 border border-[#ff2d55]/30 text-[#ff2d55] hover:bg-[#ff2d55] hover:text-white transition-all duration-300 shadow-[0_0_15px_rgba(255,45,85,0.2)]"
                              title="Live Demo"
                            >
                ...
                <TiltProjectCard className="h-full">
                  <div className="flex flex-col justify-between h-full space-y-3">
                    ...
                    <div className="space-y-1.5">
                      <h4 className="text-xl font-bold text-white tracking-tight font-playfair group-hover:text-[#ff2d55] transition-colors">
                        {project.title}
                      </h4>
                      ...
                      <div className="flex items-center gap-2 flex-shrink-0">
                        {project.demo && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="p-2 rounded-xl bg-[#ff2d55]/10 border border-[#ff2d55]/30 text-[#ff2d55] hover:bg-[#ff2d55] hover:text-white transition-all duration-300"
                            title="Live Demo"
                          >
