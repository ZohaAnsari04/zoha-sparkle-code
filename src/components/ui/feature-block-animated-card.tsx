...
export function AnimatedCard({ className, title, description, icons = [] }: AnimatedCardProps) {
    return (
        ...
        >
            ...
            >
                <AnimatedIcons icons={icons} id="card-main" />
            </div>
            {title && (
...
export function AnimatedIcons({
    ...
    return (
        <div className={cn("p-8 overflow-hidden h-full relative flex items-center justify-center", containerClassName)}>
            <div className={cn("flex flex-row flex-shrink-0 justify-center items-center gap-2", className)}>
